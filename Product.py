...
lbl = Label(root, text="Let's Multiply Two Numbers", fg="white", bg="#0b1f84", height=2, width=300)
lbl.pack(pady=10)

n1_lbl = Label(root, text="Enter Number 1", bg="#1637dd")
n1_lbl.pack()

n1_entry = Entry(root, width=20)
n1_entry.pack(pady=5)

n2_lbl = Label(root, text="Enter Number 2", bg="#1637dd")
n2_lbl.pack()
...
btn = Button(root, text="Calculate", command=multiply, height=1, bg="#067bad", fg="white")
btn.pack(pady=5)
